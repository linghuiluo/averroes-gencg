 ...
 *     <p>Provides dex related utils.
 */
public class DexUtils {

  /**
   * dexlib2 does not provide means to create a raw dex file. This method serves as utility to
   * return an object of type "RawDexFile".
   *
   * @return
   */
    ...
    try {
      ...
      if (zipEntry == null) {
        throw new FileNotFoundException(
            "zip file" + dexFile.getName() + " does not contain a " + zipEntryName + " file");
      }
