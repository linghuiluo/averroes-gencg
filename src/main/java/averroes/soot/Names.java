...
public class Names {
  ...
  public static final String LIBRARY_POINTS_TO_FIELD_SIGNATURE =
      "<" + AVERROES_ABSTRACT_LIBRARY_CLASS + ": java.lang.Object " + LIBRARY_POINTS_TO + ">";
  public static final String FINALIZE_POINTS_TO = "finalizePointsTo";
  public static final String FINALIZE_POINTS_TO_FIELD_SIGNATURE =
      "<" + AVERROES_ABSTRACT_LIBRARY_CLASS + ": java.lang.Object " + FINALIZE_POINTS_TO + ">";
  public static final String INSTANCE = "instance";
  public static final String INSTANCE_FIELD_SIGNATURE =
      "<"
          + AVERROES_ABSTRACT_LIBRARY_CLASS
          + ": "
          + AVERROES_ABSTRACT_LIBRARY_CLASS
          + " "
          + INSTANCE
  ...
  public static final String RTA_SET_FIELD_SIGNATURE =
      "<" + RTA_CLASS + ": java.lang.Object " + SET_FIELD_NAME + ">";
  public static final String RTA_INT_FIELD_SIGNATURE =
      "<" + RTA_CLASS + ": int " + INT_FIELD_NAME + ">";
  public static final String RTA_BOOLEAN_FIELD_SIGNATURE =
      "<" + RTA_CLASS + ": boolean " + BOOLEAN_FIELD_NAME + ">";
  public static final String AVE_GUARD_FIELD_SIGNATURE =
      "<" + AVERROES_ABSTRACT_LIBRARY_CLASS + ": boolean " + GUARD_FIELD_NAME + ">";
  public static final String RTA_GUARD_FIELD_SIGNATURE =
      "<" + RTA_CLASS + ": boolean " + GUARD_FIELD_NAME + ">";
  public static final String XTA_GUARD_FIELD_SIGNATURE =
      "<" + XTA_CLASS + ": boolean " + GUARD_FIELD_NAME + ">";

  // Methods
  public static final String AVERROES_DO_IT_ALL_METHOD_NAME = "doItAll";
  public static final String MAIN_METHOD = "main";
  public static final String AVERROES_ABSTRACT_DO_IT_ALL_METHOD_SIGNATURE =
      "<" + AVERROES_ABSTRACT_LIBRARY_CLASS + ": void " + AVERROES_DO_IT_ALL_METHOD_NAME + "()>";
  public static final String AVERROES_LIBRARY_DO_IT_ALL_METHOD_SIGNATURE =
      "<" + AVERROES_LIBRARY_CLASS + ": void " + AVERROES_DO_IT_ALL_METHOD_NAME + "()>";
  public static final String AVERROES_LIBRARY_CLINIT_METHOD_SIGNATURE =
      "<" + AVERROES_LIBRARY_CLASS + ": void " + SootMethod.staticInitializerName + "()>";
